export const MENUITEMS = [
    ...
    },
    {
        ...
        Items: [
            {
                title: 'Auth Pages', icon: "fe fe-users", type: 'sub',Name:"",Names:"", active: false, selected: false, children: [
                    { path: `${process.env.PUBLIC_URL}/authentication/login`, type: 'link', active: false, selected: false, title: 'Login Page' },
                    { path: `${process.env.PUBLIC_URL}/authentication/register`, type: 'link', active: false, selected: false, title: 'Signup Page' },
                    { path: `${process.env.PUBLIC_URL}/authentication/forgotpassword`, type: 'link', active: false, selected: false, title: 'Forgot Password Page' },
    ...
    },
    {
        ...
        Items: [
            {
                title: 'Charts', icon: "fe fe-bar-chart-2", type: 'sub',Name:"",Names:"", badge: "badge bg-secondary side-badge", badgetxt: "3", children: [
            ...
            },
            {
                title: 'Icons', icon: "fe fe-wind", type: 'sub',Name:"",Names:"", children: [
                    ...
                    { path: `${process.env.PUBLIC_URL}/icons/paymenticons`, type: 'link', active: false, selected: false, title: ' Payment Icons' },
                    { path: `${process.env.PUBLIC_URL}/icons/materialdesignicons`, type: 'link', active: false, selected: false, title: ' Material-Design Icons' },
