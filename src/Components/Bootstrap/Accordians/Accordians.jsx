                ...
                <Accordion defaultActiveKey="0" className="red">
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      ...
                      anim id est laborum. Fusce aliquet neque et accumsan
                      fermentum. Aliquam lobortis neque in nulla tempus,
                      molestie fermentum purus euismod.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="1">
                      ...
                      {`<Accordion defaultActiveKey="0" className="red">
                          <Accordion.Item eventKey="0">
                            ...
                            <Accordion.Body>
                              ...
                              laborum. Fusce aliquet neque et accumsan
                              fermentum. Aliquam lobortis neque in nulla tempus,
                              molestie fermentum purus euismod.
                            </Accordion.Body>
                          </Accordion.Item>
                    ...
                    >
                      <Accordion.Item eventKey="0" className="acc_section ">
                        ...
                        <Accordion.Body>
                          ...
                          deserunt mollit anim id est laborum. Fusce aliquet
                          neque et accumsan fermentum. Aliquam lobortis neque in
                          nulla tempus, molestie fermentum purus euismod.
                        </Accordion.Body>
                      </Accordion.Item>
                    </Accordion>
                  </div>
                            ...
                            >
                              ...
                              >
                                ...
                                <Accordion.Body>
                                  ...
                                  aliquet neque et accumsan fermentum. Aliquam
                                  lobortis neque in nulla tempus, molestie
                                  fermentum purus euismod.
                                </Accordion.Body>
                              </Accordion.Item>
                            </Accordion>
                          </div>
