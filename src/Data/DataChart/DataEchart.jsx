...
export const LargeScaleAreaChart = () => {
...
export const StepLineChart = () => {
  const option = {
    ...
    legend: {
      data: ["Step First", "Step Second", "Step Third"],
      textStyle: {
        color: "#afc4ea",
      },
    },
    ...
    series: [
      {
        ...
        type: "line",
        step: "start",
        data: [120, 132, 101, 134, 90, 230, 210, 100, 150, 200, 150, 250],
      },
      {
        name: "Step Middle",
        type: "line",
        step: "middle",
        data: [220, 282, 201, 234, 290, 430, 410, 300, 350, 200, 250, 280],
      },
      {
        name: "Step End",
        type: "line",
        step: "end",
        data: [450, 432, 401, 454, 590, 530, 510, 400, 450, 480, 500, 600],
      },
    ],
  };
...
export const BarwithBackground = () => {
  const options = {
    grid: {
      top: 6,
      right: 0,
...
export const BarChartwithNegativeValue = () => {
  const labelRight = {
    position: "right",
  };
  const options = {
...
export const ExponentialRegression = () => {
  const option = {
    xAxis: {
      scale: true,
    },
