              ...
              <Row className="py-5">
                <div className="text-center">
                  ...
                  <p className="">
                    ...
                    to as necessary All the Lorem Ipsum generators on the
                    Internet tend to repeat Various versions have evolved over
                    repeat Various versions have evolved over.
                  </p>
                </div>
              </Row>
            </Col>
                      ...
                      <Col xl={6}>
                        <div className="">
                          <h2 className="fw-bold">
                            We Help to
                            <span className="text-primary">Build</span> Your
                            Dream Project.
                          </h2>
                          ...
                          <p>
                            ...
                            available, but the majority have suffered by
                            injected humour, or randomised words which don't
                            look even slightly believable.
                          </p>
                          <p>
                            All the Lorem Ipsum generators on the Internet tend
                            to repeat Various versions have evolved over the
                            years, sometimes by accident, sometimes on purpose
                            (injected humour and the like).
                          </p>
                          <p>
                            If you are going to use a passage of Lorem Ipsum,
                            you need to as necessary All the Lorem Ipsum
                            generators on the Internet tend to repeat Various
              ...
              <Card className="mt-5">
                <Card.Body className="about-con pabout">
                  ...
                  <p className="leading-normal">
                    ...
                    Ipsum, you need to as necessary All the Lorem Ipsum
                    generators on the Internet tend to repeat Various versions
