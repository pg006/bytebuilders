            ...
            <Card>
              ...
              <Card.Body className="pb-2">
                <p>
                  ...
                  <code className="highlighter-rouge">&lt;textarea&gt;</code> s
                  an upgrade with custom styles,focus states, and more.
                </p>
            ...
            <Card>
              ...
              <Card.Body className="">
                <p>
                  ...
                  className to remove the default form field styling and
