              ...
              <Container className="main-container">
                <div className="d-flex">
                  ...
                  <Navbar className="d-flex order-lg-2 ms-auto header-right-icons">
                    ...
                    <div
                      className="responsive-navbar p-0"
                      id="basic-navbar-nav"
                    >
                      <NavbarCollapse
                  ...
                  <Row>
                    ...
                    >
                      ...
                      <h1 className="text-start fw-bold">
                        ...
                        <span className="text-primary animate-heading">
                          Sash
                        </span>
                      </h1>
                      <h6 className="pb-3">
                      ...
                      <Container>
                        <Row>
                          ...
                          <p className="text-default mb-5 text-center">
                            ...
                            features that are completely easy-to-use for any
                            user, even for a beginner.
                          </p>
                          <Row className="mt-7">
                            <Col lg={6} md={12}>
                              <Card
                              ...
                              >
                                ...
                                <div className="text-left">
                                  ...
                                  <p className="mb-0">
                                    The Sash admin code is maintained very
                            ...
                            <Col lg={6} md={12}>
                              ...
                              >
                                ...
                                <div className="text-left">
                                  ...
                                  <p className="mb-0">
                                    We included multiple demos, preview video,
                                    and screen shots to give a quick overview of
                                    our Sash admin template.
                                  </p>
                                </div>
                              </Card>
                            </Col>
                              ...
                              >
                                ...
                                <div className="text-left">
                                  ...
                                  <p className="mb-0">
                                    ...
                                    material for the Sash admin template. The
                                    documentation is explained or instructed in
                                    such a way that every user can understand.
                                  </p>
                                </div>
                              </Card>
                            </Col>
                                    ...
                                    <Col xl={6} lg={6} className="pe-0 my-auto">
                                      <div className="ps-5">
                                        <h2 className="text-start fw-semibold fs-25 mb-6">
                                          We are a creative agency with a
                                          passion for design.
                                        </h2>
                                        <div className="d-flex">
                                          <span>
                                        ...
                                        <div className="d-flex">
                                          ...
                                          <div className="ms-5 mb-4">
                                            ...
                                            <p>
                                              ...
                                              clear-cut material for the Sash
                                              admin template. The documentation
                                              is explained or instructed in such
                                              a way that every user can
                                              understand.
                                            </p>
                                          </div>
                                        </div>
                              ...
                              <Row className="align-items-center">
                                ...
                                <Col lg={12}>
                                  <Row className="justify-content-center">
                                    ...
                                    >
                                      The Sash admin template is one of the
                                      modern dashboard templates. It is also a
                                      premium admin dashboard with high-end
                                      features, where users can easily customize
                                      or change their projects according to
                                      their choice. Please take a quick look at
                                      our template highlights.
                                    </Col>
                                  </Row>
                                  <Row id="grid">
                                    <Col lg={6}>
                                          ...
                                          >
                                            ...
                                            <Accordion.Body className="pt-0">
                                              <p>
                                                ...
                                                Dashboard Template is available
                                          ...
                                          >
                                            ...
                                            <Accordion.Body className="pt-0">
                                              <p>
                                                The Sash – Bootstrap 5 Admin &
                                                Dashboard Template is available
                                                in LRT & RTL versions with
                                                single assets. Using those
                                                single assets, it’s very easy to
                                                switch from one version to
                                                another version.
                                              </p>
                                              <p className="mt-2 mb-3">
                                                <span className="fw-bold">
                                          ...
                                          >
                                            ...
                                            <Accordion.Body className="pt-0">
                                              <p>
                                                The Sash – Bootstrap 5 Admin &
                                                Dashboard Template is available
                                                in different types of color
                                                styles. Where the users can
                                                change their template completely
                                                with those color styles.
                                              </p>
                                              <p className="mt-2 mb-3">
                                                <span className="fw-bold">
                                                  Note:
                                          ...
                                          >
                                            ...
                                            <Accordion.Body className="pt-0">
                                              <p>
                                                ...
                                                “Boxed” Layouts. So that user
                                                can switch their dashboard from
                                                one layout to another layout
                                                effortlessly.
                                              </p>
                                              <p className="mt-2 mb-3">
                                                <span className="fw-bold">
                                          ...
                                          >
                                            ...
                                            <Accordion.Body className="pt-0">
                                              <p>
                                                ...
                                                Side Menu Styles. Where the
                                                users can change their Side Menu
                                          ...
                                          >
                                            ...
                                            <Accordion.Body className="pt-0">
                                              <p>
                                                ...
                                                can switch their Template from
                                                one layout to another layout
                                                easily.
                                              </p>
                                              <p className="mt-2 mb-3">
                        ...
                        <Row>
                          ...
                          <Row className="justify-content-center">
                            ...
                            >
                              ...
                              easily customize or change their projects
