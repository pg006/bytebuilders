                      ...
                      <ul className="icons-list">
                        ...
                        <li className="icons-list-item">
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip>ion-arrow-graph-up-right</Tooltip>
                            }
                          >
                            <i
                        ...
                        <li className="icons-list-item">
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip>ion-arrow-graph-down-left</Tooltip>
                            }
                          >
                            <i
                        ...
                        <li className="icons-list-item">
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip>ion-ios7-arrow-thin-right</Tooltip>
                            }
                          >
                            <i
                        ...
                        <li className="icons-list-item">
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip>ion-ios7-arrow-thin-down</Tooltip>
                            }
                          >
                            <i
                        ...
                        <li className="icons-list-item">
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip>ion-ios7-arrow-thin-left</Tooltip>
                            }
                          >
                            <i
                        ...
                        <li className="icons-list-item">
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip>ion-ios7-checkmark-empty</Tooltip>
                            }
                          >
                            <i
                        ...
                        <li className="icons-list-item">
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip>ion-ios7-refresh-outline</Tooltip>
                            }
                          >
                            <i
