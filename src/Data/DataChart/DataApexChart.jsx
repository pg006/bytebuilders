...
export const DateTime = () => {
  const [selection, setSection] = useState("one_year");
    ...
    <div id="chart">
      <div className="toolbar text-center">
        <Button
          ...
          className={`${selection === "one_month" ? "active" : ""}  mb-3 me-2`}
        >
          1M
        </Button>
        &nbsp;
        <Button
          ...
          className={`${selection === "six_months" ? "active" : ""}  mb-3 me-2`}
        >
          6M
        </Button>
        &nbsp;
        <Button
          ...
          className={`${selection === "one_year" ? "active" : ""}  mb-3 me-2`}
        >
          1Y
        </Button>
        &nbsp;
        <Button
          ...
          className={`${selection === "ytd" ? "active" : ""}  mb-3 me-2`}
        >
          YTD
        </Button>
        &nbsp;
        <Button
          ...
          className={`${selection === "all" ? "active" : ""}  mb-3 me-2`}
        >
          ALL
        </Button>
      </div>
...
export const ColumnNegativeValue = () => {
  const series = [
    {
      data: [
...
export const BasicCandlestickChart = () => {
  const series = [
    {
      data: [
        {
...
export const BoxplotScatterChart = () => {
  const series = [
    {
      name: "Data 1",
      type: "boxPlot",
...
export const UpdateDonut = () => {
  const [series, setSeries] = [44, 55, 13, 33];
  const options = {
    chart: {
      width: 380,
      type: "donut",
...
export const BasicPolarChart = () => {
  const series = [14, 23, 17, 15, 10];
  const options = {
    chart: {
      type: "polarArea",
    },
