                      ...
                      <div className="me-5 mt-5 mt-md-0">
                        <div className="media mb-4">
                          ...
                          <div className="media-body">
                            ...
                            <span>2004-2008</span>
                            <p>
                              Graduation: Bachelor of Science in Computer
                              Science
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="media mt-0">
                      ...
                      <div className="ms-auto">
                        <div className="d-flex mt-1">
                          <Link className="new me-2 text-muted fs-16" to="#;">
                            <span className="">
                          ...
                          <Link className="new text-muted fs-16" to="#;">
                            <span className="">
                      ...
                      <div className="media media-xs overflow-visible">
                        ...
                        <div className="">
                          <div className="social social-profile-buttons float-sm-end">
                            <Link className="social-icon bg-white" to="#">
                              <i className="fa fa-facebook"></i>
                            </Link>
                            <Link className="social-icon bg-white" to="#">
                              <i className="fa fa-twitter"></i>
