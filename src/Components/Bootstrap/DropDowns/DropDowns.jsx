              ...
              <Card.Body>
                <div className="text-wrap">
                  <p>
                    ...
                    can be turned into Link dropdown toggle with some markup
                    changes.The best part is you can do this with any button
                    variant, too
                  </p>
                  <div className="example">
                    <ButtonGroup className="mt-2 mb-2 me-3">
                      <Dropdown>
                    ...
                    <ButtonGroup className="mt-2 mb-2 me-3">
                      <Dropdown>
                        <Dropdown.Toggle variant="pink" id="dropdown-basic">
                          Action
                        </Dropdown.Toggle>
                        <Dropdown.Menu>
                          <Dropdown.Header>Dropdown</Dropdown.Header>
                          <Dropdown.Divider className="bg-pink" />
                          <Dropdown.Item eventKey="1">Action</Dropdown.Item>
                          <Dropdown.Item eventKey="2">
                            Another action
                          </Dropdown.Item>
              ...
              <Card.Body>
                <div className="text-wrap">
                  ...
                  <div className="example">
                    ...
                    <ButtonGroup className="mt-2 mb-2 me-3">
                      <SplitButton variant="outline-pink" title="Action">
                        <Dropdown.Header>Dropdown</Dropdown.Header>
                        <Dropdown.Divider />
                        <Dropdown.Item eventKey="1">Action</Dropdown.Item>
                        <Dropdown.Item eventKey="2">
              ...
              <Card.Body>
                <div className="text-wrap">
                  ...
                  <div className="example">
                    ...
                    <ButtonGroup className="mt-2 mb-2 me-3">
                      <SplitButton variant="pink" title="Action">
                        <Dropdown.Header>Dropdown</Dropdown.Header>
                        <Dropdown.Divider className="bg-pink" />
                        <Dropdown.Item eventKey="1">Action</Dropdown.Item>
                        <Dropdown.Item eventKey="2">
            ...
            <Card>
              ...
              <Card.Body>
                <div className="text-wrap">
                  ...
                  <div className="example d-flex align-items-end">
                    <ButtonGroup className="mt-2 mb-2 me-3">
                      <Dropdown>
                        <Dropdown.Toggle
                          size="lg"
            ...
            <Card>
              ...
              <Card.Body>
                <div className="text-wrap">
                  ...
                  <div className="example">
                    <ButtonGroup className="dropup mt-2 mb-2 me-3">
                      <Dropdown>
                        <DropdownButton
                          drop="up"
                          variant="primary"
                    ...
                    <ButtonGroup className="dropend mt-2 mb-2 me-3">
                      <DropdownButton
                        drop="end"
                        variant="primary"
                        title="Drop right"
                    ...
                    <div className="dropstart btn-group mt-2 mb-2 me-3">
                      <DropdownButton
                        drop="start"
                        variant="primary"
                        title="Drop left"
              ...
              <Card.Body>
                <div className="text-wrap">
                  ...
                  <div className="example">
                    ...
                    <Dropdown className="btn-group mt-2 mb-2 me-3">
                      <Dropdown.Toggle
