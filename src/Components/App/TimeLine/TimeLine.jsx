...
import PageHeader from "../../../commonComponents/PageHeader/PageHeader.jsx";
                ...
                <div className="vtimeline">
                    ...
                    <div className="timeline-panel">
                      ...
                      <div className="timeline-footer d-flex align-items-center flex-wrap">
                        ...
                        <span className="ms-auto">
                          <i className="fe fe-calendar text-muted mx-1"></i>19
                          Oct 2020
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="timeline-wrapper timeline-wrapper-green">
                    ...
                    <div className="timeline-panel">
                      ...
                      <div className="timeline-body">
                        <p>
                          Alpha 5 has arrived just over a month after Alpha 4
                          with some major feature improvements and a boat load
                          of bug fixes.
                        </p>
                      </div>
                      <div className="timeline-footer d-flex align-items-center flex-wrap">
                  ...
                  <div className="timeline-wrapper timeline-inverted timeline-wrapper-danger">
                    ...
                    <div className="timeline-panel">
                      <div className="timeline-heading">
                        <h6 className="timeline-title">
                          Eroll Maxhuni uploaded 4 new photos to album Summer
                          Trip
                        </h6>
                      </div>
                      <div className="timeline-body">
                    ...
                    <div className="timeline-panel">
                      ...
                      <div className="timeline-body">
                        <p>
                          ...
                          elit. Amet cupiditate, delectus deserunt doloribus
                          earum eveniet explicabo fuga iste magni maxime
                        </p>
                      </div>
                      <div className="timeline-footer d-flex align-items-center flex-wrap">
                        <i className="fe fe-heart text-muted me-1"></i>
