...
import "./Buttons.scss";
import { Buttondata, Checkedbutton } from "../../../Data/Boostrap/ButtonData";
                ...
                <div className="text-wrap">
                  ...
                  <div className="example">
                    <div className="btn-list">
                      ...
                      <Link to="#" className="btn btn-light btn-link">
                        Link
                      </Link>
                    </div>
                  </div>
            ...
            <Card>
              ...
              <Card.Body>
                <div className="text-wrap">
                  ...
                  <div className="example">
                    <div className="btn-list">
                      <Link to="#" className="btn btn-default disabled">
                        Default
                      </Link>
                      ...
                      <Link to="#" className="btn btn-light btn-link disabled">
                        Link
                      </Link>
                    </div>
                  </div>
                  ...
                  <pre>
                    <code>
                      {`<div className="btn-list">
                          ...
                          <Link
                            to="#"
                            className="btn btn-light btn-link disabled"
                          >
                            Link
                          </Link>
                        </div>`}
                ...
                <div className="text-wrap">
                  ...
                  <div className="example">
                    <div className="btn-list">
                      ...
                      <Link to="#" className="btn btn-success btn-pill">
                        Success
                      </Link>
                      <Link to="#" className="btn btn-info btn-pill">
                        Info
                      </Link>
                      <Link to="#" className="btn btn-warning btn-pill">
                        Warning
                      </Link>
                      <Link to="#" className="btn btn-danger btn-pill">
                        Danger
                      </Link>
                    </div>
                  </div>
            ...
            <Card>
              ...
              <Card.Body>
                <div className="text-wrap">
                  ...
                  <div className="example">
                    <div className="btn-list">
                      <Link to="#" className="btn btn-default-light">
                        Default
                      </Link>
                      ...
                      <Link to="#" className="btn btn-info-light ">
                        Info
                      </Link>
                      <Link to="#" className="btn btn-warning-light ">
                        Warning
                      </Link>
                ...
                <div className="text-wrap">
                  ...
                  <div className="example">
                    <div className="btn-list">
                      ...
                      <Link to="#" className="btn btn-azure">
                        Azure
                      </Link>
                      ...
                      <Link to="#" className="btn btn-gray-dark">
                        Dark gray
                      </Link>
                    </div>
                  </div>
                  ...
                  <pre>
                    <code>
                      {`<div className="btn-list">
                          ...
                          <Dropdown>
                            <Dropdown.Toggle variant="info">
                              <i className="fe fe-calendar me-2"></i>Show
                              calendar
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
                              <Dropdown.Item eventKey="1">
