...
import "./FormInputSpinnersPage.scss";
import { Row, Col, Card, Form, Spinner } from 'react-bootstrap';
import PageHeader from "../../../../commonComponents/PageHeader/PageHeader";


const FormInputSpinnersPage = () => {
  return (
    <React.Fragment>
      <div>
        <PageHeader
          titles="Form Input Spinners Page"
...
export default FormInputSpinnersPage;
