        ...
        <Row>
          ...
          <Col lg={6}>
            <Card className="custom-card">
              <Card.Header className="border-bottom">
                <Card.Title as="h3">
                  Square File_Attachment with link
                </Card.Title>
              </Card.Header>
          ...
          <Col lg={6}>
            <Card className="custom-card">
              <Card.Header className="border-bottom">
                <Card.Title as="h3">
                  Rounded File_Attachment with link
                </Card.Title>
              </Card.Header>
              <Card.Body className="p-4 p-sm-5">
                <p>
                ...
                <div className="tags">
                  <ButtonGroup
                    ...
                    aria-label="Basic example"
                  >
                    <Link to="#" className="btn btn-pill btn-info text-white">
                      <i className="mdi mdi-file-image mx-2"></i>Image01..._jpg
                    </Link>
                    <Link
                      to="#"
              ...
              <Card.Body className="p-4 p-sm-5">
                ...
                <div className="tags">
                  <ButtonGroup
                    ...
                    aria-label="Basic example"
                  >
                    <Link to="#" className="btn btn-sm btn-primary text-white">
                      <i className="mdi mdi-file-image mx-2"></i>Image01..._jpg
                    </Link>
                    <Link
                      to="#"
                  ...
                  <ButtonGroup
                    ...
                    aria-label="Basic example"
                  >
                    <Link to="#" className="btn btn-lg btn-pink">
                      <i className="mdi mdi-file-pdf fs-20 me-2"></i>AMN0012.pdf
                    </Link>
                    <Link
                      to="#"
              ...
              <Card.Body className="p-4 p-sm-5">
                ...
                <div className="tags">
                  ...
                  <ButtonGroup
                    ...
                    aria-label="Basic example"
                  >
                    <Link to="#" className="btn btn-pill btn-lg btn-pink">
                      <i className="mdi mdi-file-pdf fs-20 me-2"></i>AMN0012.pdf
                    </Link>
                    <Link
                      to="#"
